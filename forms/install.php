	...
	<html>
	<head>
		<title>JeffWtest01 - created by phpFormGenerator</title>
	...
	<div id="mainForm">
		...
		<div id="formHeader">
				<h2 class="formInfo">JeffWtest01</h2>
 ...
 if(isset($_POST['submit']))
  {
	 ...
	 field_6 TEXT ,
	 field_7 TEXT ,
	 field_8 TEXT )") or die("Error! Table not be created.");
...
{ ?>
<li class="mainForm"><label class="formFieldQuestion">Hostname&nbsp;&nbsp;</label><input class=mainForm type=text name=dbHostName size='20' value='localhost'></li><li class="mainForm"><label class="formFieldQuestion">User&nbsp;&nbsp;</label><input class=mainForm type=text name=dbUser size='20' value='jeff'></li><li class="mainForm"><label class="formFieldQuestion">Password&nbsp;&nbsp;</label><input class=mainForm type=text name=dbPassword size='20' value=''></li><li class="mainForm"><label class="formFieldQuestion">Database&nbsp;&nbsp;</label><input class=mainForm type=text name=dbName size='20' value='gms2'></li><li class="mainForm"><label class="formFieldQuestion">Table&nbsp;&nbsp;</label><input class=mainForm type=text name=dbTable size='20' value='felllow'></li><li class="mainForm"><input class=mainForm type=submit name=submit value='Install'></li></form>
<?php }
