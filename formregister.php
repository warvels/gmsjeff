<!-- 
 * Register form - formregister.php
...
-->
	...
	<div id="mainForm">
		...
		<div id="formHeader">
				...
				<p class="formInfo">Register for Global Mind Share</p>
		</div>


		<BR/><!-- begin form -->
		<form method=post enctype=multipart/form-data action=processorregister.php onSubmit="return validatePage1();"><ul class=mainForm id="mainForm_1">
				...
				<li class="mainForm" id="fieldBox_7">
					<label class="formFieldQuestion">State - US&nbsp;*</label><select class=mainForm name=field_7 id=field_7>
